docker:
  containers:
    # Barrier Breaker
    builder-openwrt-vb07bfcb-bb-ar71xx:
      image: wlanslovenija/openwrt-builder
      tag: vb07bfcb_bb_ar71xx
      environment:
        ...
        VIRTUAL_URL: /firmware/git.b07bfcb/openwrt/barrier_breaker/ar71xx/
    builder-openwrt-vb07bfcb-bb-lantiq:
      image: wlanslovenija/openwrt-builder
      tag: vb07bfcb_bb_lantiq
      environment:
        BUILDER_PUBLIC_KEY: ssh-rsa  builder@wlan-si.net
        VIRTUAL_HOST: packages.wlan-si.net
        VIRTUAL_URL: /firmware/git.b07bfcb/openwrt/barrier_breaker/lantiq/
    # Chaos Calmer
