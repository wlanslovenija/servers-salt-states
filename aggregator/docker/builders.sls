docker:
  containers:
    # Barrier Breaker
    builder-openwrt-vd9a8baa-bb-ar71xx:
      image: wlanslovenija/openwrt-builder
      tag: vd9a8baa_bb_ar71xx
      environment:
        ...
        VIRTUAL_URL: /firmware/git.d9a8baa/openwrt/barrier_breaker/ar71xx/
    builder-openwrt-vd9a8baa-bb-lantiq:
      image: wlanslovenija/openwrt-builder
      tag: vd9a8baa_bb_lantiq
      environment:
        BUILDER_PUBLIC_KEY: ssh-rsa  builder@wlan-si.net
        VIRTUAL_HOST: packages.wlan-si.net
        VIRTUAL_URL: /firmware/git.d9a8baa/openwrt/barrier_breaker/lantiq/
    # Chaos Calmer
