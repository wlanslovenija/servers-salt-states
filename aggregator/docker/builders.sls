docker:
  containers:
    # Barrier Breaker
    builder-openwrt-v3f106ae-bb-ar71xx:
      image: wlanslovenija/openwrt-builder
      tag: v3f106ae_bb_ar71xx
      environment:
        ...
        VIRTUAL_URL: /firmware/git.3f106ae/openwrt/barrier_breaker/ar71xx/
    builder-openwrt-v3f106ae-bb-lantiq:
      image: wlanslovenija/openwrt-builder
      tag: v3f106ae_bb_lantiq
      environment:
        BUILDER_PUBLIC_KEY: ssh-rsa  builder@wlan-si.net
        VIRTUAL_HOST: packages.wlan-si.net
        VIRTUAL_URL: /firmware/git.3f106ae/openwrt/barrier_breaker/lantiq/
    # Chaos Calmer
